...
CATEGORY_PROMPTS: Dict[str, str] = {
    "Civil Department": "a photo of a pothole, broken road, damaged pavement, footpath issue, water leakage, or flooded road",
    "Health Department": "a photo of overflowing garbage, trash pile, public toilet filth, or waste issue",
    "Horticulture": "a photo of fallen tree, unmaintained park, dry plants, or damaged greenery",
    "Electrical Department": "a photo of a broken streetlight, non-functional street lamp, dangling electric wire, or open transformer",
    "Commercial": "a photo of municipal billing disputes or commercial licensing issues",
    "Enforcement": "a photo of encroachment, illegal parking, public nuisance, unlawful occupation, or traffic jam",
    "VBD Department": "a photo of stagnant water breeding mosquitoes or vector-borne disease risks",
    "EBR Department": "a photo of illegal construction or building code violations",
    "Fire Department": "a photo of a fire hazard or flammable garbage dump",
    "IT Department": "a photo of portal errors or app bugs",
}
