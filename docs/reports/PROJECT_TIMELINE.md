...
gantt
    ...
    Docker Compose production profile           :h2, 2026-04-14, 1d
    NDMC deployment environment config          :h3, 2026-04-15, 1d
    API versioning rollout                      :h4, 2026-04-16, 1d
    MongoDB backup strategy                     :h5, 2026-04-17, 1d
    UI and branding pass                        :h6, 2026-04-18, 1d

    section Week 13 Testing Sprint
    Backend unit test expansion                 :t1, 2026-04-20, 1d
    API integration matrix                      :t2, 2026-04-21, 1d
    Security penetration test pass              :t3, 2026-04-22, 1d
    Locust load benchmark                       :t4, 2026-04-23, 1d
    Mobile responsiveness fixes                 :t5, 2026-04-24, 1d

    section Week 14 Pre-Handover
    NDMC handover guide                         :u1, 2026-04-27, 1d
    Final API reference                         :u2, 2026-04-28, 1d
    Repository cleanup                          :u3, 2026-04-29, 1d
    Release candidate preparation               :u4, 2026-04-30, 1d
```
