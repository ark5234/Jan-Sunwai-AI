...
\screenshotcard[Home Page Hero]{0.48\textwidth}{fig:s01}{../../images/screenshots/S01_home_desktop.png}{Home Page Hero and Public Entry CTA}
\screenshotcard[AI Analysis Result]{0.48\textwidth}{fig:s02}{../../images/screenshots/S02_analyze_result.png}{AI Analysis Result and Draft Review}

\screenshotcard[Citizen Tracking Dashboard]{0.48\textwidth}{fig:s03}{../../images/screenshots/S03_citizen_dashboard.png}{Citizen Complaint Tracking Dashboard}
\screenshotcard[Worker Assignment Queue]{0.48\textwidth}{fig:s04}{../../images/screenshots/S04_worker_dashboard.png}{Worker Assignment Queue}

\screenshotcard[Admin Dashboard]{0.96\textwidth}{fig:s05}{../../images/screenshots/S05_admin_dashboard_desktop.png}{Admin Dashboard --- shows real-time complaint volume and department breakdown.}
\screenshotcard[Admin Triage Queue]{0.96\textwidth}{fig:s06}{../../images/screenshots/S06_triage_queue.png}{Administrative Triage Queue --- displays low-confidence AI classifications.}
